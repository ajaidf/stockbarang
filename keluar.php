...
<html lang="en">
                ...
                <main>
                    ...
                    <img src="tcm.PNG">
                        <div class="card mb-4">
                            ...
                            <a href=exportkeluar.php class="btn btn-success">Cetak Data</a>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $ambilsemuadatastock = mysqli_query($conn, "select * from keluar m, stock s where s.codebarang = m.codebarang");
                                            $i = 1;
                                        ...
                                        <tr>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <input type="text" name="penerima" value="<?=$penerima;?>" class="from-control" required>
                                                <br>
                                                <br>
    ...
    <form method="post">
        ...
        <br>
        <br>
        <input type="text" name="penerima" placeholder="Penerima" class="from-control" required>
        <br>
        <br>
        <input type="text" name="departemen" placeholder="Departemen" class="from-control" required>
        <br>
        <br>
        <input type="number" name="qty" placeholder="Jumlah" class="from-control" required>
        <br>
        <br>
        <button type="submit" class="btn btn-primary" name="kurang" >Submit</button>
        </div>
        </form>
