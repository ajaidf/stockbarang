...
<html lang="en">
                    ...
                    <img src="tcm.PNG">
                        <div class="card mb-4">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                ...
                                <a href=export.php class="btn btn-success">Cetak Data</a>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $stock;?></td>
                                            <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$codebarang;?>">
                                            Edit
                                            </button>
                                         ...
                                         <!-- Edit Modal -->
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <br>
                                                <input type="text" name="tipe" value="<?=$tipe;?>" class="from-control" required>
                                                <br>
                                                <br>
                                                <input type="text" name="deskripsi" value="<?=$deskripsi;?>" class="from-control" required>
                                                <br>
                                                <br>
                                                <input type="number" name="stock" value="<?=$stock;?>" class="from-control" required>
                                                <br>
                                                <br>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            ...
            <br>
            <input type="text" name="tipe" placeholder="Tipe Barang" class="from-control" required>
            <br>
            <br>
            <input type="text" name="codebarang" placeholder="Kode Barang" class="from-control" required>
            <br>
            <br>
            <input type="text" name="deskripsi" placeholder="Deskripsi" class="from-control" required>
            <br>
            <br>
            <input type="number" name="stock" placeholder="Jumlah" class="from-control" required>
            <br>
            <br>
